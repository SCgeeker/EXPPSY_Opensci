...
本章開頭引述的段落來自兩本談論心理學再現危機(replication crsis)的科普書：*七大罪* [@chambersSevenDeadlySins2017]以及*[科學的假象](https://www.books.com.tw/products/0010969432?srsltid=AfmBOoovwZlTzVrIDAgl5ozbRJGT7QvcarBgIEftgcBsP0zrIPwx50GH)* [@ritchieScienceFictionsHow2020]，兩本書的作者都是參與心理科學再現危機重要事件的第一線心理科學研究者。這兩段話在書中的脈絡都是與讀者討論彼此認知的**科學方法**(scientific method)[^01-intro-1]，究竟出了什麼問題？這兩本書在開放科學提倡者之間有極大迴響，但是在更大眾的出版市場，影響力相當有限。本書主筆之一認為無法發揮更大影響力的主因，是這兩本書定位目標讀者，必須是有科學研究經驗的專業科學家或公民科學參與者。這群讀者對於**科學方法**的了解是透過親身參與，而非只是透過閱讀專業書藉或參考資料，記憶他人給你的解釋而已。透過介紹這兩本書，使用本書學習心理學實驗研究方法的同學應該能明白這本教科書的主要功能 -- 引導你從完整參與可重製實驗研究的過程，啟發獨立判斷心理學研究品質的眼光。如果你認真完成至少一項本書提供的研究專案範本(或者與你的指導教授合作的研究專案)，產生閱讀*七大罪*與*科學的假象*的興趣，就達到我們編寫這本教科書的中長程目標之一了。
...
也許有些同學在繼續讀下去的時候(或者聽教授繼續解釋)，會被一些既定印象困惑。其中一些應該像是「科學方法不就是操作科學儀器嗎？」、「心理學的科學方法不就是編量表、寫實驗程式碼嗎？」。其實這些印象只是科學研究過程的一部分，也許是來自你的親身經歷或者聽聞某些學長姐描述的經驗，完整的**科學方法**涵蓋*從提出問題到收集分析資料，做出結論的科學研究過程。*操作儀器的活動比較容易影像化，比較容易觸及你我的眼球，影像記憶較深刻的學生也許要花些功夫克服這些印象，才能繼續學習。如果你有這樣的困惑，又很難靠個人意志擺脫，不妨與你所在學校的專業教授當面聊一聊。
...
## 為何需要知道科學方法 {#sec-intro_what}

<!--- 以大多數人以為的科學方法舉例--->

也許更多同學需要更實際的理由，才能接受要了解科學方法的必要性。近年網路社群的推波助瀾，30歲以下的族群在社交場合常用「邁爾斯-布理格斯性格分類指標」（Myers-Briggs Type Indicator，簡稱MBTI）來與新朋友開啟話題。我們可以由這個現象，想想自己現在習慣看待世界的方式：你會不會習慣以容易分類的方式看待自已及互動的他人？你能不能接受測驗結果的分類？你認為MBTI是一種經過科學檢驗的測驗嗎？更進一步可以想一想，了解或不了解科學方法會如何影響你的世界觀。

MBTI的開發者邁爾斯母女，是基於對心理學的興趣，自學精神分析學者卡爾·榮格(Carl Gustav Jung)的心理類型理論，而提出的 16 型人格理論以及測驗方法。榮格認為人類的人格源自先天的秩序，要了解一個人的行為，必須先了解其所屬的性格類型。邁爾斯母女的理論主張每個人都有一種「真實」的人格類型，會導致所觀察到個體的行為差異。也就是你能簡單解釋擅長與人溝通的人是「E人」，不大愛講話的朋友是「I人」的基本主張[@Stein-2019]。



![MBTI的人格類型關鍵詞及解釋。圖片取自網路。](images/cw-image-resizer.cwg.webp){#fig-scimethod fig-align="center"}

如果你認為這樣的人格分類是科學的，那麼就需要了解為何在網路社群帶起討論熱潮前，只有美國企業的人力資源部門會使用MBTI測驗，社會及人格心理家都不會探討這個理論及測驗[@Stein-2019, p.1]。主要原因有兩方面：首先是測驗題目的施測結果缺乏信度(reliability)與效度(validity)，任何人重複施測會得到不一致的結果。好比你今天心情比較好的話，會測出屬於E類型，隔天心情變差再做測驗就變成I類型。

另一個原因是開發者邁爾斯母女主張任何人都有「真實」的性格，不會受到所生活的文化環境及成長經驗所影響，如此開發出的MBTI測驗必然是反映個人的「真實」性格，不可能測出「虛假」人格。如此的主張已經不具備使用科學方法的基本條件～任何可用科學方法檢驗的理論或假設，必須**可被檢驗為否**。這是學習任何科學究方法的學生首先會遇到的關卡，卻是真正的科學能累積知識成果的基礎。

::: {.callout-tip title="否證的哲學" collapse="true" style="color: gray"}
人類對世界如何運作的理解其實是根據自已提出的猜測及主張，科學理論也是一種主張，只是更講究要站在有證據的立場。但是如果能提出支持主張的證據，任何主張似乎都有足夠的說服力。上個世紀奧地利哲學家卡爾．波柏(Karl Popper)就提出「否證」才是科學理論不同於其他人主張關鍵區別：他認為「科學理論無法加以驗證，而只能加以否證」，科學理論「必須有遭遇否證的可能」而且「可否證程度越高越好」。詳細說明可參考[林正弘 (2020)。〈卡爾．波柏〉，王一奇（編），《華文哲學百科》（2020 版本）。](http://mephilosophy.ccu.edu.tw/entry.php?entry_name=卡爾．波柏)
:::
...
## 科學心理學知識的更新循環 {#sec-intro_cycle}

現代科學的生產知識流程源自十七世紀英國哲學家弗蘭西斯·培根提出的**排除歸納法**[^01-intro-2]，這是人類思想史上第一套科學方法論。此後隨著科學的總體發展，科學方法論述不斷改進，但是任何一派方法學論都有肯定歸納推理(Inductive Reasoning)和演繹推理(Deductive Reasoning)兩種思考過程的價值。


::: {.callout-tip title="演繹推理的古典起源" collapse="true" style="color: gray"}
...
本章開頭引述的兩本書描述的**科學方法**，正是符合多數科學家共識的知識生產循環流程。 @fig-scimethod 展示的循環流程圖，是改編自 @raoStatisticsTruthPutting1997 的圖解。圖中的*橢圓*代表能用文字或可視覺化的圖表呈現的階段性產物，*箭頭*及內嵌的*文字說明方塊*展示每個階段的思考過程。所有科學研究方法的課程，都是帶領學習者調整、改造自已的思考過程，按照符合科學原則的流程檢視自己已經知道與尚未知道的事物。

## 為何需要學習開放科學操作 {#sec-intro_why}

如果學生可以認同真正的科學研究應該按照如同 @fig-scimethod 的循環流程，就能持續產生有益人類文明發展的知識，也許不需要與真人教師互動上課。但是現實的科學研究人員，並不是人人都按著前述的流程進行研究工作。不是從事科學研究工作的一般民眾，若只以發言者有科學家身份就相信其主張，其實是不夠謹慎的。以下談一談現實的科學研究狀況。

本章一開始曾提到一個有些聳動的名詞：**再現危機(Replication crisis)**，這是泛指心理科學領域從2011年起，透過檢討違反學術倫理的個案，以及多項跨實驗室合作再現專案，可成功再現原始研究結果不及一半，眾多心理學者意識到的各種問題[參考 @penningtonStudentGuideOpen2023 的名詞解釋]。最常被討論的問題有**發表偏誤**(Publication Bias)，**不正當的研究操作**(Questionable Research Practices, QRPs)，以及**缺乏透明度**(lack of transparency)[^01-intro-3]。最後一種問題的根源是許多心理科學及多數社會科學領域的研究者缺乏開放研究內容的觀念，在民主社會公民意識為主的現代，民眾應當了解大部分科學研究是受到政府單位的經費補助才能進行，而政府單位提供的經費是來自每一個合法公民的納稅，因此你我都有權知曉受政府補助的研究案內容。科學家也有義務向大眾揭露研究細節。

<!---

::: {.callout-tip title="科學研究的理益衝突" collapse="true" style="color: gray"}
- 接受私人資本集團補助的科學研究

:::

@frankTeachingReplication2012 與 @chopikHowWhetherTeach2018 都指出許多有創新意義的心理學研究，缺乏保障信度的再現研究支持。原因是研究者在研究過程中，並不總是按照**科學方法**的思考及作業原則規劃研究設計及分析資料，特別是與統計分析有關的「設計實驗」和「檢驗假說」兩個步驟，採用不正當的研究操作(Quetionable Research Practices)。研究人員會採用不正當的研究操作的動機之一，是未明確區分探索性和確證性研究。@chopikHowWhetherTeach2018 指出，心理學研究經常從初步的探索結果擷取決定性的結論，而非進行嚴格的假設檢驗，導致研究者高估證據力。發表偏誤的來源則是只有符合研究者預期且統計顯著的結果能被期刊接受，但是不符合預期或無法再現的研究結果無法得到發表的機會。 @frankTeachingReplication2012 指出摻雜發表偏誤的一系列研究會讓其他研究者高估實驗效應，以及扭曲整合分析的估計值。
--->

這一章一開始引用的「七宗罪」及「科學的假象」都對再現危機做了完整的介紹：「七宗罪」指出其中一個主要問題是許多研究結果**缺乏可靠性**。「科學的假象」作者認為，這是因為心理學社群過度重視新穎、正面的結果，卻忽略**再現**的重要性，導致許多研究結果無法被其他心理學家重複驗證。
兩本書對於為何多數心理學研究結果不可靠，整理出以下原因：
...
總而言之，再現危機突顯的問題，顯示科學研究不只是直線式地檢驗假設、收集及分析資料、然後歸納出結論。每一步思考過程都很容易被人類偏見扭曲，產生不只一種行動選擇。因此，實際的科學研究進程，其實更像是進入一座花園迷宮，前方道路有分歧的歧路花園[^01-intro-4]。
...
- 介紹replication crisis

這本書探討了心理學的七宗罪，並指出其中一個主要問題是**缺乏可靠性**。 心理學過於重視新穎、正面的結果，而忽略了**複製**的重要性，導致許多研究結果無法被其他科學家重複驗證。 

* 心理學界普遍存在**出版偏誤**，期刊傾向於發表那些具有顯著統計效應、新穎且正面的研究結果，而忽視那些無法顯示顯著效應或只是重複他人研究的研究。
* 這種對新穎性的追求導致**概念性複製**取代了直接複製。概念性複製是指使用不同的實驗方法來驗證先前的研究結果，但這種做法存在著主觀性、未來可能無法複製以及確認偏誤等問題。
* 此外，心理學界還存在著**低統計效力**、**未公開完整的研究方法**、**統計謬誤**以及**拒絕撤回不可複製的研究結果**等問題，這些問題都導致了心理學研究結果的不可靠性。
* 許多心理學家反對直接複製的原因在於學術文化鼓勵新穎性，而且直接複製的研究難以獲得資金支持和在知名期刊上發表。
* 有些心理學家甚至認為直接複製是不可能的，因為原始研究結果可能受到許多隱藏變數的影響，而這些變數對於原始研究者和試圖複製研究者來說都是不可見的。
* 書中還探討了**p 值**的誤解問題，並指出**貝氏推論方法**可以作為一種替代方案。
* Chris Chambers呼籲心理學界重視直接複製，提高統計效力，採用更嚴謹的統計方法，公開研究資料和方法，並及時撤回不可靠的研究結果，以提高心理學研究的可靠性。

一些心理學家認為，複製型研究的問題在於其**樣本數過小**(Moore et al., 2023; Zwaan et al., 2018)。 然而，研究指出，認知心理學的許多效應其實非常穩健，即使在線上環境中使用非實驗新手作為受試者，也能夠穩定地複製出來(Zwaan et al., 2018)。  Zwaan 等人（2018）的研究重製了認知心理學九個經典效應，發現在這些特定的認知作業中，即使受試者並非實驗新手，實驗結果依然穩定，表示這些認知作業的實驗結果並不容易受到過往經驗或是實驗情境的影響。 

心理學領域的複製危機引發了人們對於其研究結果可靠性的擔憂。  雖然有人認為只有一半的實驗結果可以被複製，這個說法可能不適用於所有科學文獻，但這個問題依然值得我們關注。  部分原因是學術界「**不發表就滾蛋**」的文化，迫使科學家為了追求職涯發展而犧牲了研究品質。  心理學家為了在競爭激烈的環境中生存(Ritche, 2020)，不得不發表大量充斥著事後解釋的低品質論文(Chambers, 2016)。


---

**《科學的假象》探討了科學界，特別是心理學領域，普遍存在的「再現危機」**。再現危機指的是許多已發表的科學研究成果，無法被其他科學家用同樣的研究方法重複驗證。 書中指出，心理學界過於重視新穎、正面的研究結果，導致**出版偏誤**的現象十分普遍。 在這種文化下，期刊傾向於刊登那些具有統計顯著性差異、新穎且吸引人的研究成果，而那些無法獲得正面結果，或是單純重複驗證他人研究成果的論文，則會被期刊拒於門外。

由於學術界以論文發表數量作為評鑑指標，導致「**不發表就滾蛋**」的文化十分盛行。 科學家為了在競爭激烈的環境中生存，被迫不斷發表論文，而期刊對於新穎性的偏好，更加助長了這種不健康的文化。


Chris Chambers的書列舉了心理學研究的七宗罪，並指出缺乏可靠性是其中一項嚴重的問題。 造成這個問題的原因很多，除了出版偏誤以外，還包括以下幾點：

*   **低統計檢定力**：許多心理學研究的樣本數太小，導致統計檢定力不足，難以偵測到微小的效應。 
*   **p 值操縱**：為了讓研究結果看起來具有統計上的顯著性差異，有些科學家會刻意操弄 p 值。
*   **缺乏透明度**：許多科學家沒有公開他們的研究數據和方法，導致其他研究人員難以重複驗證他們的結果。
*   **概念性複製取代了直接複製**：為了追求新穎性，許多科學家選擇採用概念性複製來驗證先前的研究，而不是採用更嚴謹的直接複製。
...
## 有指引的開放科學操作 {#sec-intro_opensci}

<!---


解方正是稍早我們先談過的幾項開放科學操作：[預印本](#intro_opensci_preprint)、[開放資料及分析程式碼](#intro_opensci_opencode)、[開放研究材料](#intro_opensci_openmaterials)。而前兩種問題的根源是無法被再現的原始研究者，並未充分按照[前一節](#intro_cycle)介紹的科學方法完成知識更新流程。

為了改善現況，Chris Chambers(2017)籲採取一系列改革措施，包括：

* **採用預先註冊報告（Registered Reports）**：在收集數據之前，公開註冊研究計畫和分析方法，以減少發表偏誤和事後諸葛效應（HARKing）。
* **提高統計效力**: 確保研究有足夠的樣本數和統計效力，以檢測出真實的效應。
* **公開研究資料和方法**:  讓其他研究者能夠檢驗和複製研究結果，提高研究的透明度和可信度。 
* **採用貝氏統計方法**:  可以提供比傳統的虛無假設顯著性檢定（NHST）更有意義的結果。
* **改革學術文化**:  改變以數量為導向的評鑑方式，重視研究品質和可複製性，才能真正改善心理學研究的現狀。 

《科學的假象》也探討了其他學科的「再現危機」。  書中指出，從總體經濟學、地球科學到機器學習等領域，都面臨著研究結果難以再現的問題。  書中舉例說明了許多看似嚴謹的論文，在經過重新分析後，卻發現原始數據有誤、統計方法有瑕疵，甚至根本是刻意造假。

為了改善科學界的「再現危機」，書中建議採取以下措施：

*   **採用預先註冊報告（Registered Reports）**:  科學家在收集數據之前，事先公開註冊他們的研究計畫和分析方法，讓研究結果更加透明，並減少發表偏誤以及事後諸葛效應（HARKing）的影響。 
*   **提高統計檢定力**:  科學家應確保他們的研究有足夠的樣本數和統計檢定力，才能有效檢測出真實的效應。 
*   **公開研究數據和方法**:  讓其他研究人員能夠檢驗和複製研究結果，提高研究結果的可信度。 
*   **改革學術文化**:  改變以數量為導向的評鑑方式，重視研究品質和可複製性，才能真正改善科學研究的現狀。 

書中也強調了開放科學的重要性，建議科學家公開分享他們的預印本、數據、分析程式碼以及研究材料，讓科學研究的過程更加透明，並促進科學合作。

雖然 sources 中沒有直接評論《科學的假象》這本書對於再現危機的描述是否恰當，但從 中可以看出，再現危機在心理學和其他科學領域確實是一個備受關注的議題，而 sources 中提到的解決方案也與書中的建議相呼應。

延續*開放科學的實踐方法*一節介紹的研究操作
、**大型合作研究專案**及**統合科學**
--->

以初識實驗研究的教材來說，再現危機所曝曬的問題都直指最基本的研究觀念養成，因此本書的設計主軸之一是介紹初學實驗研究的學生，能學會並實用的**開放科學操作**。這些操作每年都有更新的指引或新的工具出現，不過核心原則都是一致的。本書將介紹的開放科學操作包括**預先註冊**與**註冊報告**、**可重製的樣本數估計及資料分析方法**、以及**開放資料操作指引**。這些操作將結合後續各章主題，進行深入介紹，還有提供同學演練例題。


<!---

，除了增加研究過程的透明度，我們現在也知道，要設定一種合理標準，保障研究過程的可重製性及研究結果的再現程度。因此這一節介紹的，目的是評估已知研究的可重製程度，或者保障原創或再現研究的可重製性
...
| [OSF Prereg](https://www.cos.io/initiatives/prereg)                                           | 量化/實驗研究                  | @bowmanOSFPreregTemplate2020                                                              |
| [PRP-Quant](https://www.psycharchives.org/en/item/088c79cb-237c-4545-a9e2-3616d6cc8453),[shiny app](https://stef.shinyapps.io/prp-quant/) | 量化/實驗研究                  | @bosnjakTemplatePreregistrationQuantitative2022                                           |
...
經由本書主要學習的統計方法涵蓋與**實驗設計**有關的樣本數估計，以及驗證**歸納推理**的資料分析方法。這些統計方法在基礎統計課程都有教授，但是多數大學提供學生的只有統計理論及實作方法的初步入門，在真正的研究場景要如何正確使用統計，歸納有助了解人類心智運作的科學知識，正是這門課程要學習的目標。本書將運用已發表的重製專案為材料，從案例探討中學習如何選擇及使用正確的統計方法。

<!---除了正--->

### 開放資料操作指引

所謂開放資料不只是將研究資料公開到任何人都能自由檢索的公開網站而己，還有如何解釋及使用資料的元資料(meta data)。本書將參照FAIR公開資料協議[^01-intro-6]，說明如何挑選可尋得(Findable)且可取用(Accessible)的公開資料儲存庫，以及要公開的資料如何能與其他來源資料相互整合(Interoperabble)，還有重覆使用(Reusable)。本書讀者可透過評估已發表的研究公開資料符合各項原則的條件，以及實作範例認識如何運用FAIR的指引。


## 研究倫理基本須知 {#sec-intro_ethics}
...
- 因實驗操作的需要，事前隱暪部分內容，會不會損害參與者權益？
例如：分班實施不同的教學法，比較學生的學習表現。
...
[^01-intro-6]: FAIR四大項目原則說明 \~ https://www.go-fair.org/fair-principles/