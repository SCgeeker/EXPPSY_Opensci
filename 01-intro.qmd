...
本章開頭引述的兩本書描述的**科學方法**，正是符合多數科學家共識的知識生產循環流程。以上的循環流程圖，是改編自 @raoStatisticsTruthPutting1997 的圖解  。圖中的*橢圓*代表能用文字或可視覺化的圖表呈現的階段性產物，*箭頭*及內嵌的*文字說明方塊*展示每個階段的思考過程。所有科學研究方法的課程，都是帶領學習者調整、改造自已的思考過程，按照符合科學原則的流程檢視自己已經知道與尚未知道的事物。
