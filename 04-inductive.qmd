...
> 如果**Wave**與**Similarity**不影響**specific condition**的平均值差異，一項重製實驗的原始平均值，非常有可能符合以下線性模型：
...
$\gamma$ ~ **specific condition**

$\varepsilon$ ~ **residuals** 下標符號提示參與者間獨變項

> 如果**Wave**與**Similarity**並無差異，則符合以下線性模型
...
- 運用所學，嘗試重製附錄中每項實驗的統計資訊，以及Table S1 ~ Table S10的效果量數值。
...
[@moorePervasivenessEffectsSamplebased2023]


- 敏感度分析

實驗設計必知三角關係：考驗力 - 樣本數 - 效果量
...
在台灣地區找除了慣用語言，其他條件儘可能一致的人士參與九項認知實驗的再重製，要考慮那些條件？
