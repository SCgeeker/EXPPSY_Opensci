...
Simon Task得名於第一篇論文的主要通訊作者[@Craft-1970]，後續研究累積至今已成為認知心理學者研究人類處理刺激位置與動作位置不一致的心智歷程，首先運用的方法。@fig鄉ch04-fig04 取自 @boniniActionMonitoringMedial2014 的論文，是 @Craft-1970 設計的一種版本。描繪的作業內容只有兩大類試驗：刺激與反應位置一致嘗試(Congruent Trials)；刺激與反應位置不一致嘗試(Incongruent Trials)，許多研究都能重製一致嘗試的平均反時間比不一致嘗試短的結果。而且不論刺激換成任何形式，或者改用別種感官刺激，都能重製相同結果。
