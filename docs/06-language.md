...
@zwaanParticipantNonnaiveteReproducibility2017 重現的形態模擬效應效果量範圍在0.3到0.6之間，屬於中量級的效果量，不同版本的實驗結果推測的人數有很大差異(圖\@ref(fig:shape-simulation))。無論如何，這項實驗顯示句子理解的研究要得到高考驗力的實驗結果，需要累積60人以上的樣本。
