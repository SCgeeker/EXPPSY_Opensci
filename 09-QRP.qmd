...
```{r DF-checklist, echo=FALSE, message=TRUE, warning=TRUE, paged.print=TRUE, fig.cap="研究彈性檢核表。取自Wicherts et al.(2016)"}
knitr::include_graphics("figs/fpsyg-07-01832-t001.jpg")
```
