...
```{r fmemory-power, echo=FALSE, fig.show='hold', message=FALSE, warning=FALSE, paged.print=TRUE, out.width='50%', fig.cap="估計錯誤記憶誤答率之考驗力與參與者人數。左圖:前後參與相同刺激，右圖:前後參與不同刺激"}
knitr::include_graphics(c("figs/FalseMemory_participant_same_1.png","figs/FalseMemory_participant_diff_1.png"))
```
