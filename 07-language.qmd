...
<a href="Chinese_word_LDT.html" target="_blank">詞彙判斷作業示範網頁</a>
::: 
...
與 @Forster-1984 的結果相比， @Zwaan-2018  測得的重覆促發效應少於前者：高頻真詞~ 30毫秒對比10毫秒；低頻真詞~ 63毫秒對比45毫秒。不過換算為效果量，低頻真詞的重覆促發效應(`r round( mean(c(1.11,1.18,.82,1.34)), 2 )`)明顯高出高頻真詞的效應(`r round( mean(c(.44,.31,.36,.46)), 2 )`)一個量級，所以還是一項成功的再現成果。
